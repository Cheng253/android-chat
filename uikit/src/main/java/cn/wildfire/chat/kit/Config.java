...
public class Config {
     ...
     * <br>
     */
    public static String IM_SERVER_HOST /*请仔细阅读上面的注释，没有 http 前缀，配置错误时，APP 会提示配置错误，然后直接退出*/ = "192.168.1.2";
     ...
     */
    public static String ORG_SERVER_ADDRESS/*请仔细阅读上面的注释*/ = "https//192.168.1.2:8880";
